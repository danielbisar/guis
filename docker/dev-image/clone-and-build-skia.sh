...
apt-get update
apt-get upgrade -y
apt-get install -y libfreetype6-dev libglib2.0-dev libcairo2-dev meson pkg-config gtk-doc-tools generate-ninja git libjpeg-dev libgl-dev libicu-dev libwebp-dev cmake
